...
def create_nuscenes_infos(root_path,
    ...
    if test:
        ...
        info_path = osp.join(root_path,
                             '{}_infos_test_radar_coor_1.pkl'.format(info_prefix))
        ...
        data = dict(infos=train_nusc_infos, metadata=metadata)
        info_path = osp.join(root_path,
                             '{}_infos_train_radar_coor_1.pkl'.format(info_prefix))
        mmcv.dump(data, info_path)
        data['infos'] = val_nusc_infos
        info_val_path = osp.join(root_path,
                                 '{}_infos_val_radar_coor_1.pkl'.format(info_prefix))
...
def get_2d_boxes(nusc,
    ...
    for ann_rec in ann_recs:
        ...
        if mono3d and (repro_rec is not None):
            ...
            print("mono3d is set to true, need to change the coordinate here")
            # dim = box.wlh
...
if __name__ == '__main__':
    # create_nuscenes_infos('/mnt/workspace/datasets/nuscenes/', 'radar_nuscenes_5sweeps', version='v1.0-mini')
    create_nuscenes_infos('/mnt/ws-frb/users/jingyuso/dataset/nuScenes_mini/', 'radar_nuscenes_5sweeps', version='v1.0-mini')