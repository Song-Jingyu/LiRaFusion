...
# from plugin.lirafusion.models.backbones.radar_encoder import build_radar_encoder
...
class CenterPoint_voxel_fusion(MVXTwoStageDetector):
    ...
    def __init__(self,
                pts_voxel_layer=None,
                 ...
                 pretrained=None,
                 init_cfg=None):
        super(CenterPoint_voxel_fusion,
    ...
    def simple_test(self, points, img_metas, img=None, rescale=False, fused_points=None):
    ...
    def aug_test(self, points, img_metas, imgs=None, rescale=False, fused_points=None):
        """Test function with augmentaiton."""
        img_feats, pts_feats = self.extract_feats(points, img_metas, imgs, fused_points=fused_points)
        bbox_list = dict()
        if pts_feats and self.with_pts_bbox:
    ...
    def extract_feats(self, points, img_metas, imgs=None, fused_points=None):
        """Extract point and image features of multiple samples."""
        if imgs is None:
            imgs = [None] * len(img_metas)
        img_feats, pts_feats = multi_apply(self.extract_feat, points, imgs,
                                           img_metas, fused_points=fused_points, mode='test')
        return img_feats, pts_feats